...
class AppColors {
  ...
  static const Color textSecondary = Color(0xFF8B92B2);
  static const Color textTertiary = Color(0xFF6A7189);
  static const Color textHint = Color(0xFFA5A9C0);
  ...
  static const Color inactive = Color(0xFFA5A9C0);
